---
title: A DATA ANALYSIS REPORT ON REFRESHER TRAINING, STUDENTS' RECORD SECTION, UNIVERSITY
  OF CAPE COAST
...
```{r chart1, echo=FALSE, dpi=500, fig.align='left', similar_training.width=900}
...
similar_training
```
```{r chart2, echo=FALSE, dpi=500, out.width="700px"}
